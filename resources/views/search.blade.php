	                      ...
	                      <div class="project col-md-4" data-filter="{{$project->project_category->name}}">
	                        <div class="project-inner">
	                            <div class="project-thumbnail">
	                              <a href="{{URL::to('/')}}/project/{{$project->slug}}" title=""><img width="400" height="250" src="{{ asset('img/loading-blog.gif') }}" data-src="{{$project->photo ? asset('images/media/'. $project->photo->file) : asset('img/200x200.png') }}" class="lazy img-fluid" alt="{{$project->title}}"></a>
	                              </div>
