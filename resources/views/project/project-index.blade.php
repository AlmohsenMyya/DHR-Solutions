                        ...
                        @if($projects)
                            @foreach($projects as $project)
                                <tr>
                                    ...
                                    <td data-label="Photo"><img height="50" src="{{$project->photo ? asset('images/media/'. $project->photo->file) : asset('img/200x200.png') }}" alt=""><p class="mb-0 mt-2"><a href="{{ route('project.edit', $project->id) . '?language=' . request()->input('language')}}">{{clean( trans('niva-backend.edit') , array('Attr.EnableID' => true))}}</a></p></td>
