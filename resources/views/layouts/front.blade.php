        ...
        <div class="header__content__venor">
            <div class="header__logo">
                <a href="{{url('/')}}" title="{{$setting->title}}">
                    <img width="500" height="500" class="img-fluid logo-front" src="{{$setting->photo ? asset('images/media/'. $setting->photo->file) : asset('img/200x200.png') }}" alt="logo">
                </a>
            </div>
            ...
            <div class="header7 sidebar-content">
                <div class="left-side">
                    ...
                    <div class="left-side-inner">
                        ...
                        <div class="flx-div">
                            <img src="{{ asset('img/sidebar-img.svg') }}" alt="sidebar-img.svg" >
                        </div>
                        ...
                        <div class="address-sidebar">
                            <div><img width="16" height="16" src="{{ asset('img/map-pin.svg') }}" alt="map-pin.svg" > {!!$setting->address!!}</div>
                        </div>
