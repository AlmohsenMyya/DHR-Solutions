...
@section('content')
   ...
   <div class="banner-section" data-background-image-url="{{$aboutsetting->banner_img ? $aboutsetting->banner_img : asset('img/200x200.png') }}">
               ...
               <div class="col-md-5">
                   ...
                   <div class="simpleParallax-video">
                        <div class="simpleParallax">
                            <img width="500" height="665" src="{{ asset('img/loading-blog.gif') }}" class="lazy thumparallax img-fluid" data-src="{{$aboutsetting->about_image}}" alt="about-image">
                        </div>
                ...
                @foreach($members as $member)
                  <div class="col-md-4">
                      <div class="venor-team">
                          <div class="thumbnail"> 
                              <img width="350" height="350" class="lazy img-fluid" src="{{ asset('img/loading-blog.gif') }}" data-src="{{$member->photo ? asset('images/media/'. $member->photo->file) : asset('img/200x200.png') }}" alt="team-venor">
                          </div>
                          <div class="content">
                ...
                <blockquote class="testimonial-slide">
                    <div class="testimonial-layout1">
                        <div class="item-figure">
                            <img class="img-fluid" width="90px" height="90px" src="{{$testimonial->profile_pic ? $testimonial->profile_pic :  asset('img/200x200.png') }}" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="clients-slider owl-carousel">
                  ...
                  <div class="clients-slide">
                      <a title="{{$client->company_name}}" target="_blank" href="{{$client->company_link}}"><img class="client_image owl-lazy" data-src="{{$client->photo ? asset('images/media/'. $client->photo->file) :  asset('img/200x200.png') }}" alt="{{$client->company_name}}"></a>
                  </div>
                  @endforeach
            </div>
